    ...
    return (
        <Card>
            <Form  layout='horizontal'
                ...
                <Form.Item>
                    <Input value={text} placeholder="Result..." disabled suffix={
                        <Tooltip placement="right" title={copyToClipboard ? "Copied" : "Copy"}>
                            <CopyToClipboard text={text} onCopy={() => setCopyToClipboard(true)}>
                                <CopyOutlined />
                            </CopyToClipboard>
                        </Tooltip>
                    }/>
                ...
                <Button onClick={randomBytes} style={{width: '100%', marginTop: 12}} type="primary" htmlType="submit">Random Bytes</Button>
            </Form>
        </Card>
    );
}
