...
import { Form, Input, Button, Switch, Tooltip, Row, Col } from "antd";
        ...
        >
          ...
          <div className="options">
            ...
            <Form.Item label={"Uppercase"}>
              <Switch defaultChecked={upper} onChange={onChangeUppercase} />
            </Form.Item>
            <Form.Item label={"Number"}>
              <Switch defaultChecked={number} onChange={onChangeNumber} />
            </Form.Item>
            <Form.Item label={"Symbol"}>
              <Switch defaultChecked={symbol} onChange={onChangeSymbol} />
            </Form.Item>
          </div>
          <Form.Item>
